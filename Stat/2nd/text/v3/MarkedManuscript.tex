...
As a defect engineering tool\textcolor[rgb]{0.00,0.00,1.00}{\emph{,}} US has \textcolor[rgb]{0.00,0.00,1.00}{\emph{the following}} advantages:
(i)~locality of action due to predominant absorption in \textcolor[rgb]{0.00,0.00,1.00}{\emph{the}} regions of lattice periodicity deviation;
(ii)~selectivity of influence, which depends on acoustic wave (AW) polarization and type;
(iii)~possibility \textcolor[rgb]{0.00,0.00,1.00}{\emph{to transform}} the defect system by applying resonance frequency;
(iv)~\textcolor[rgb]{0.00,0.00,1.00}{\emph{reversibility}} of effect of low intensity AW.

In piezoelectric semiconductors, the acousto--defect interaction (ADI) is \textcolor[rgb]{0.00,0.00,1.00}{\emph{mainly determined}} by electric field \textcolor[rgb]{0.00,0.00,1.00}{\emph{that}} accompanies the vibration wave propagation.
However, ADI is also observed in \textcolor[rgb]{0.00,0.00,1.00}{\emph{such}} non--piezoelectric crystals \textcolor[rgb]{0.00,0.00,1.00}{\emph{as}} silicon, the basic material in microelectronic.
Thus it was experimentally observed that US can cause
...
appearance of new defects\cite{Savkina2015,Virot} in  Si structures.
Defects are known to determine most of semiconductor devices \textcolor[rgb]{0.00,0.00,1.00}{\emph{characteristics}}.
In particular the ADI governs \textcolor[rgb]{0.00,0.00,1.00}{\emph{the}} variation of tunneling, \cite{Olikh2016JSem,Olikh2011Sem} generation--recombination \cite{Davletova2009,Davletova2008,YOlikh2005} and  thermionic emission \cite{OlikhJAP,Olikh:Ultras} currents in silicon barrier structures.
...
the local temperature increase \textcolor[rgb]{0.00,0.00,1.00}{\emph{caused }} by point defect clusters \cite{MirzadeJAP2005}
\textcolor[rgb]{0.00,0.00,1.00}{\emph{as well as}} the US absorption by dislocation\cite{Davletova2008,OstrovKor92,Olikh:Ultras2016}
are \textcolor[rgb]{0.00,0.00,1.00}{\emph{believed}} to be \textcolor[rgb]{0.00,0.00,1.00}{\emph{the}} main mechanisms of elastic vibration--defect interaction in non--piezoelectric crystals.
However to the best of our knowledge, \textcolor[rgb]{0.00,0.00,1.00}{\emph{there is no a comprehensive ADI theory for silicon suggested so far, the lack of experimental researches focused on acoustically induced (AI) effects being one of the main reasons}}.


\textcolor[rgb]{0.00,0.07,1.00}{\emph{The defects in silicon structures are not all acoustically active and can remain unmodified under the action of ultrasound.}}
The ADI efficiency depends on defect type and structure. \cite{UST:Medvid}
Thus, the force acting on the point defect \textcolor[rgb]{0.00,0.07,1.00}{\emph{in the crystal under}} US loading (USL) of crystal is determined by the relaxation of defect volume\cite{MirzadeJAP2011,PeleshchakUJF2016}.
...
On the one hand, the high--power US treatment \textcolor[rgb]{0.00,0.07,1.00}{\emph{of irradiated silicon structures has been}} shown\cite{YOlikh2007TPL,Parchinskii2006,Gorb2010,Podolian2012} \textcolor[rgb]{0.00,0.07,1.00}{\emph{to result in}} residual changes in structure properties.
This effect deals with AI annealing of radiation defects (RDs).
On the other hand, irradiation can be \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} reason of reversible AI phenomenon initiation, \cite{YOlikh2006TPL,YOlikhTPL2011} which is caused by formation of acoustically active RDs.
...
Our work presents the distinction between AI effects in silicon structures with different RDs.
The intensity of the US applied was below the level of irreversible defect subsystem modification, which can deal with?? a new defect formation, RDs annealing or a long distance (a many interatomic distance) diffusion. As a result, the complete recovery of characteristics was observed after AW propagation had stopped.

\textcolor[rgb]{0.00,0.07,1.00}{\emph{The aim of our work}} is to investigate experimentally the AI electrical characteristic variation \textcolor[rgb]{0.00,0.07,1.00}{\emph{that}} takes place in non--irradiated and irradiated $n^+$--$p$--Si structures.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{For this purpose, the samples}} were irradiated by reactor neutrons and a $^{60}$Co--gamma source \textcolor[rgb]{0.00,0.07,1.00}{\emph{rays}}.
It is \textcolor[rgb]{0.00,0.07,1.00}{\emph{supposed}} that $\gamma$--rays introduce predominantly
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{Our work presents}} distinction of AI effects in silicon structures with different RDs.
The intensity of applied US was \textcolor[rgb]{0.00,0.07,1.00}{\emph{insufficient to}} a new defect creation, a RDs annealing or a long distance (a many interatomic distance) diffusion.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{To describe the processes in space charge region (SCR) and in the diode base as well as to study shunt resistance, we used the models of coupled defect level recombination,\cite{CDLR:JAP1995,CDLR:JAP} Shockley--Read--Hall (SRH) recombination and dislocation--induced impedance,\cite{Rsh:Gopal2003,Rsh:Gopal2004} respectively. The observed AI phenomena are accounted for in terms of defect interaction with AW strain field.\cite{MirzadeJAP2011,PeleshchakUJF2016}
Our research not only provides a better understanding of ADI}} but could also facilitate the development of acoustically controlled devices or radiation sensors.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{The}} front and rear aluminium electrodes were deposited by screen printing before rapid annealing.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{The samples used in the experiment were cut from the central part of the wafer and had the area of $2$~cm$^{2}$.
The }}samples were irradiated by reactor neutrons or by $^{60}$Co $\gamma$--rays.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{The}} doses $D$, fluences $\Psi$, and sample labels are listed in Table~\ref{tabSample}.
...
Since \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} displacement damage effect is characterized by $(\Psi\cdot \mbox{NIEL})$,
...
To avoid \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} impact of  long--term annealing, which is typical to neutron damaged structure, \cite{NIEL:Moll,Rew:Srour} the irradiated samples \textcolor[rgb]{0.00,0.07,1.00}{\emph{were }}stored  for  5 years  at  room  temperature before \textcolor[rgb]{0.00,0.07,1.00}{\emph{the measurements}}.
...
We used Eqs. (\ref{eqIV})--(\ref{eqW}) to fit the experimental data \textcolor[rgb]{0.00,0.07,1.00}{\emph{taking}} $\tau_g$, $\tau_n$, $n_{\mathrm{id}}$, $R_{sh}$, and $R_s$ as the  fittings parameters.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{The}} broken lines in Fig.~\ref{figIV}(a) \textcolor[rgb]{0.00,0.07,1.00}{\emph{show}} an example of \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} calculated contributions of $I_{SCR}$, $I_{base}$, and $I_{sh}$ to \textcolor[rgb]{0.00,0.07,1.00}{\emph{full}} current.

In \textcolor[rgb]{0.00,0.07,1.00}{\emph{case of}} USL , the transverse AWs with frequency of $4.2$~MHz\textcolor[rgb]{0.00,0.07,1.00}{\emph{, which}} were exited \textcolor[rgb]{0.00,0.07,1.00}{\emph{by using}} piezoelectric transducer,  were \textcolor[rgb]{0.00,0.07,1.00}{\emph{applied to the samples at}} the base side in the [111]--direction.
The US intensities $W_{\mathtt{US}}$, amplitude of lattice deformation $\xi_{\mathtt{US}}$ and lattice atom
...
In order to wait the AI transitional period completion the following experimental procedure \textcolor[rgb]{0.00,0.07,1.00}{\emph{was}} used.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{When USL started}}, the sample \textcolor[rgb]{0.00,0.07,1.00}{\emph{was first exposed to at room temperature for}} 60~min and then the $I$--$V$ measurement and the sample heating were started.
In order to avoid the effect of piezoelectric field on $I$--$V$ characteristics, the piezoelectric transducer \textcolor[rgb]{0.00,0.07,1.00}{\emph{was}} shielded.
...
The time interval between USL \textcolor[rgb]{0.00,0.07,1.00}{\emph{initiation}} and "during" measurement was \textcolor[rgb]{0.00,0.07,1.00}{\emph{longer}} than 60~min,
the time interval between USL \textcolor[rgb]{0.00,0.07,1.00}{\emph{termination}} and "after" measurement was about 24~h.
...
The non-linear fittings were \textcolor[rgb]{0.00,0.07,1.00}{\emph{performed}} by using the differential evolution method.\cite{DEWang}


\section{Results and Discussion}
\subsection{Space charge region\label{SCR}}
The parameters of $I$--$V$ characteristic \textcolor[rgb]{0.00,0.07,1.00}{\emph{associated with}} SCR phenomena are $n_{\mathrm{id}}$ and $\tau_{g}$.
...
As shown \textcolor[rgb]{0.00,0.07,1.00}{\emph{from}} the Fig.~\ref{fig_n}\textcolor[rgb]{0.00,0.07,1.00}{\emph{,}} the ideality factor decreases with temperature increase and the  dependence of $n_{\mathrm{id}}$ on $1/T$  is close to linear.
...
The temperature dependence of $\tau_{g}$ is well described by the equation
\begin{equation}
\label{eq_TAUgT}
    \tau_{g}(T)=\tau_{g0}\exp\left(-\frac{E_{\tau g}}{kT}\right)\:.
\end{equation}
The \textcolor[rgb]{0.00,0.07,1.00}{\emph{values of}} $T_{\mathrm{id}}$ and $E_{\tau g}$ \textcolor[rgb]{0.00,0.07,1.00}{\emph{found}} for both non--irradiated and irradiated samples under USL as well as without it are listed in Table~\ref{tabTpar}.
...
We \textcolor[rgb]{0.00,0.07,1.00}{\emph{would like to}} stress that
...
\noindent
(iv)~USL leads to \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} increase  \textcolor[rgb]{0.00,0.07,1.00}{\emph{in}} both $T_{\mathrm{id}}$ and $E_{\tau g}$ in $\gamma$--irradiated samples (see Fig.~\ref{fig_n}(b) and Fig.~\ref{fig_TAUg}(b)),
...
\noindent
(vi)~ideality factor is varied by USL more effectively in irradiated samples\textcolor[rgb]{0.00,0.07,1.00}{\emph{.}}
...
For the purpose of \textcolor[rgb]{0.00,0.07,1.00}{\emph{our analysis}} it is important to discuss the recombination mechanism in SCR of the investigated samples.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{However,}} all the observed features of SCR recombination (large ideality factor, independence on light intensity, dependence on temperature
...
The phenomenon was \textcolor[rgb]{0.00,0.07,1.00}{\emph{first}} observed experimentally,\cite{DAPR:Chen1991,DAPR:Chen1994}  \textcolor[rgb]{0.00,0.07,1.00}{\emph{after which}} it was recruited to explain process in semiconductor diodes. \cite{CDLR:JAP1995,CDLR:JAP,CDLR:SSP}

According to CDLR model, recombination is the result of carrier exchange between two defect level and crystal bands.
In particular, it is \textcolor[rgb]{0.00,0.07,1.00}{\emph{supposed}} \cite{CDLR:JAP} that the recombination rate is \textcolor[rgb]{0.00,0.07,1.00}{\emph{dominant at the}} sites where acceptor--like defect is coupled with donor-like defect.
In simplified case, \textcolor[rgb]{0.00,0.07,1.00}{\emph{when there is }}no carrier exchange between the donor level $E_t^{\mathtt{D}}$ and the valence band,
...
CCS for defect in a pair differs from that for \textcolor[rgb]{0.00,0.07,1.00}{\emph{an}} isolated defect and depends on the distance $r$ between donor and acceptor:
\begin{equation}
\label{eqSigma}
\sigma_{n,p}^{\mathtt{D,A}}(r)=C_{n,p}^{\mathtt{D,A}}\,r^2\,,
\end{equation}
where $C_{n}^{\mathtt{D}}$ and $C_{p}^{\mathtt{A}}$ are constant values.
$R_{\mathtt{DA}}$ is proportional to the overlap integral of the defects wave functions too.
...
In fact, according to data,\cite{MirzadeJAP2011,PeleshchakUJF2016} the force acting on the point defect during USL can be expressed as
\begin{equation}
\label{eqFd}
...
$\Delta\Omega_d > 0$ for \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} interstitial atoms and substitutional impurities with ionic radius exceeding the ionic radius of matrix
atoms, whereas
for \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} vacancies and substitutional impurities \textcolor[rgb]{0.00,0.07,1.00}{\emph{whose}} ionic radius \textcolor[rgb]{0.00,0.07,1.00}{\emph{is}} smaller than that of matrix atoms $\Delta\Omega_d < 0$.
...
and axis X is drawn through \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} point defect initial positions.
Under USL, \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} defects would vibrate with amplitudes $u_\mathtt{D}$ and $u_\mathtt{A}$.
The vibration axis coincides with AW displacement direction and forms angle $\varphi$ with  X--axis.
...
In addition, $\varepsilon_{\mathtt{RDA}}$ depends on
$|u_\mathtt{D}-u_\mathtt{A}|$ ($\delta=0^\circ$ case) or $|u_\mathtt{D}+u_\mathtt{A}|$ ($\delta=180^\circ$ case).
...
Relative changes of CCS depends on oscillation amplitudes with similar features and
...
Eq.~(\ref{eqEpsSig}) takes into account that $u_\mathtt{D},u_\mathtt{A}\propto \xi_\mathtt{US}\propto\sqrt{W_\mathtt{US}}$.


% Thus, the axis of donor--acceptor pair with ( ΔΩ_d D ΔΩ_d  A>0)  should be predominantly parallel to dislocation line, whereas the axis of a pair of coupled defects with ΔΩ_d D ΔΩ_d  A<0 should make a right angle with dislocation line. As AW displacement is parallel to p-n junction plane, the cases of the most exciting interest are the following:


It is worth keeping in mind that
CDLR current flows locally in the locations of extended defects.\cite{CDLR:JAP,CDLR:SSP}
\textcolor[rgb]{0.00,0.07,1.00}{\emph{At the same time, the}} dislocations are often located perpendicularly to $p-n$ junction plane in the SCR region,
and the investigated samples are not exception (see Section~\ref{Rsh}).
If coupled defects and dislocations are close to each other, then the dislocations with edge component should affect the pair spatial orientation.
...
the cases of most exciting interest are \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} following:
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{Moreover}}, only squares \textcolor[rgb]{0.00,0.07,1.00}{\emph{should}} to be under consideration in case of $\Delta\Omega_d^\mathtt{D}\cdot\Delta\Omega_d^\mathtt{A}>0$.

Taking into account the experimental results and the \textcolor[rgb]{0.00,0.07,1.00}{\emph{estimation suggested by our model}}:
...
g6SC defect is coincident to g7SC defect and differs from neutron--irradiated sample defect.
...
The transformation is confirmed by \textcolor[rgb]{0.00,0.07,1.00}{\emph{the enhanced efficiency of US action on defects}} in irradiated samples.
...
In our opinion, both donor and acceptor are of interstitial--type defects in non--irradiated sample, and one of pair component is of vacancy--type defect in irradiated samples.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{As expected,}} minority carrier lifetime \textcolor[rgb]{0.00,0.07,1.00}{\emph{increases as the temperature grows}}, and at 320~K,
$\tau_n$ values comprise  $2\div5$~$\mu$s for different samples, which
correspond to $80\div130$~$\mu$m range of diffusion lengths.
In our opinion, the observed $\tau_n$ dispersion \textcolor[rgb]{0.00,0.07,1.00}{\emph{is caused not by irradiation, but rather}} deals with sample--ancestor wafer inhomogeneity, which \textcolor[rgb]{0.00,0.07,1.00}{\emph{is often the case}}.\cite{Oxide:Chen,Oxide_Schon}
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{As seen from the table,}} the estimated value of radiation--induced $\tau_n^{-1}$ change comprise ($8\div17$), 4, and 29~\% of
its values measured for samples nSC, g6SC and g7SC, respectively, \textcolor[rgb]{0.00,0.07,1.00}{\emph{so this}} cannot explain the dispersion observed experimentally.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{At the same time, the}} calculated lifetime changes $K_\tau\Psi$ are in quite a good agreement with those expected from RDs production --- see Section~\ref{DefectType}.
...
are listed in Table~\ref{tabAIchange}.
As AI changes are reversible, the lifetime alteration, in our opinion, deals with increase of $\sigma_n$ under US action.
Following the empirical relation  proposed by Ref.~\onlinecite{CDLR:R2}, we assume that Eq.~(\ref{eqSigma})
is \textcolor[rgb]{0.00,0.07,1.00}{\emph{valid}} for a complex point defect \textcolor[rgb]{0.00,0.07,1.00}{\emph{as well}}.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{In this case, however, }}$r$ is the distance which separates the components of a complex.
...
\sum_l^{M_d^\mathtt{nonAA}}N_{d,l},\sigma_{n,l}\,\upsilon_{\mathrm{th},n}\,.\nonumber
\end{eqnarray}
\textcolor[rgb]{0.00,0.07,1.00}{\emph{By}} using Eq~(\ref{eqEpsSig}), $\varepsilon_{\tau n}$  \textcolor[rgb]{0.00,0.07,1.00}{\emph{is transformed}} as follows
\begin{equation}
\label{eqEpsTAU}
...
The obtained dependences \textcolor[rgb]{0.00,0.07,1.00}{\emph{of}} $\varepsilon_{\tau n}$ vs $W_\mathtt{US}$ are shown in Fig.~\ref{fig_Kus}.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{The}} linearity of these dependences prove the correctness of our assumptions.
The \textcolor[rgb]{0.00,0.07,1.00}{\emph{obtained}} $K_\mathtt{US}^\mathtt{eff}$ values are listed in Table~\ref{tabTAUn}.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{Also,}} the $R_{sh}$ temperature dependence changes after $\gamma$--irradiation.
In particular  the shunt resistance decreases with the temperature growth in iSC and nSC,
whereas in g6SC and g7SC the increase of $R_{sh}$ vs $T$  i\textcolor[rgb]{0.00,0.07,1.00}{\emph{s close to linear at the vicinity of}} 293~K.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{It should be noted}} that $R_{sh}$ axis is logarithmic in Fig.~\ref{fig_Rsh}(a) and linear in Fig.~\ref{fig_Rsh}(b).
...
In the course of firing, Al particle \textcolor[rgb]{0.00,0.07,1.00}{\emph{can}} penetrate into the sample creating $p^+$--doped region around it, which compensates the emitter and remains in ohmic contact with the base.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{Dislocations, however,}} which intersect the junction, are generally held responsible as a possible source of ohmic current.\cite{Rsh:Breitenstein,TAT:Gopal,Rsh:Baker}
...
The resistance temperature coefficient was \textcolor[rgb]{0.00,0.07,1.00}{\emph{estimated}} from g7SC data.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{The}} obtained value $8.3\cdot10^{-3}$~K$^{-1}$ is not far from resistance temperature coefficient of bulk Al ($4.3\cdot10^{-3}$~K$^{-1}$).
To fit the experimental data for $R_{sh}$ we used Eqs.~(\ref{eqRshFull})--(\ref{eqRsh}).
\textcolor[rgb]{0.00,0.07,1.00}{\emph{As the fitting parameters,}} $R_{293,\mathtt{Al}}$, $(E_{\mathtt{dis}}-E_i)$, $U_s$, and $\sigma_{\mathtt{dis}}$ were taken.
It \textcolor[rgb]{0.00,0.07,1.00}{\emph{has been found}} that the experimental data are in good agreement with the fitting curves (see Fig.~\ref{fig_Rsh}) for values $(E_{\mathtt{dis}}-E_i)=(0.46\pm0.02)$~eV and $U_s=(5\pm4)\times10^{-8}$~eV, which were independent of irradiation and USL.
The obtained value of $(E_{\mathtt{dis}}-E_i)$ corresponds to the carrier activation energy $0.10\pm0.02$~eV and
is comparable \textcolor[rgb]{0.00,0.07,1.00}{\emph{with}} the
...
Obtained values of $R_{293,\mathtt{Al}}$ and $\sigma_{\mathtt{dis}}$ are \textcolor[rgb]{0.00,0.07,1.00}{\emph{given}} in Table~\ref{tabTpar}.
...
The irradiation \textcolor[rgb]{0.00,0.07,1.00}{\emph{facilitates}} to \textcolor[rgb]{0.00,0.07,1.00}{\emph{the formation of vacancies as well as}} Al diffusion out of the electrodes.
As a \textcolor[rgb]{0.00,0.07,1.00}{\emph{consequence}}, the \textcolor[rgb]{0.00,0.07,1.00}{\emph{number}} of Al particles \textcolor[rgb]{0.00,0.07,1.00}{\emph{grow}}, $R_{sh,\mathtt{Al}}$ decreases and becomes the key factor \textcolor[rgb]{0.00,0.07,1.00}{\emph{contributing in the}} overall shunt resistance.
Al \textcolor[rgb]{0.00,0.07,1.00}{\emph{diffuses more effectively in the samples exposed to}} $\gamma$--radiation due to a more uniform distribution of irradiation--induced single vacancies.
...
USL \textcolor[rgb]{0.00,0.07,1.00}{\emph{causes}}  $\sigma_{\mathtt{dis}}$ increase, relative AI changes
...
Therefore, the effective surface area increases and $R_{sh,\mathtt{dis}}$ decreases \textcolor[rgb]{0.00,0.07,1.00}{\emph{due to}} US action.
...
To determine the major recombination center \textcolor[rgb]{0.00,0.07,1.00}{\emph{in the}} investigated samples the following experimental procedure \textcolor[rgb]{0.00,0.07,1.00}{\emph{was}} used.
...
After illumination \textcolor[rgb]{0.00,0.07,1.00}{\emph{was terminated}}, the sample \textcolor[rgb]{0.00,0.07,1.00}{\emph{was exposed to room temperature in the darkness}}.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{Over 5~h period, $I$--$V$ characteristics were measured with the interval 10—15 min in order to determine the kinetics of the parameters at room temperature.}}
To \textcolor[rgb]{0.00,0.07,1.00}{\emph{estimate}} the permanent light--induced change, the measurements of  $I$--$V$ characteristics were performed in 48~h after illumination.
After the \textcolor[rgb]{0.00,0.07,1.00}{\emph{total}} time under illumination \textcolor[rgb]{0.00,0.07,1.00}{\emph{ran}} up to 15~h, the iSC was annealed at 200~$^\circ$C for $10$~min \textcolor[rgb]{0.00,0.07,1.00}{\emph{in darkness,  after which}} the measurements were \textcolor[rgb]{0.00,0.07,1.00}{\emph{carried out}} at room temperature.
...
Annealing at 200~$^\circ$C for $10$~min in the \textcolor[rgb]{0.00,0.07,1.00}{\emph{darkness}} results in both \textcolor[rgb]{0.00,0.07,1.00}{\emph{recovery of state and readiness to light--induced degradation of BO defects}}.
Fig.~\ref{fig_Illum} \textcolor[rgb]{0.00,0.07,1.00}{\emph{shows the}} changes of structure parameters in comparison with those \textcolor[rgb]{0.00,0.07,1.00}{\emph{prior to}} illumination.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{As seen from the figure,}} illumination \textcolor[rgb]{0.00,0.07,1.00}{\emph{does}} not result in considerable permanent change of $\tau_g$, $\tau_n$, $n_{\mathrm{id}}$ before as well as after annealing.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{which result in lifetime changes.}}
In \textcolor[rgb]{0.00,0.07,1.00}{\emph{the darkness,}} Fe$_i$B$_s$ is repaired and Fe$_i$ concentration decreases according to \cite{MurphyJAP2011,Wijaranakula}
\begin{equation}
\label{eqFeB}
N_{Fe}(t)=(N_{Fe,\,0}-N_{Fe,\,eq})\exp\left[-\frac{t}{\tau_{\mathtt{rep}}}\right]+N_{Fe,\,eq}\,,
\end{equation}
where
\textcolor[rgb]{0.00,0.07,1.00}{\emph{$N_{Fe,\,0}$ is the concentration immediately after illumination, and $N_{Fe,\,eq}$ is the equilibrium concentration which remains for a long time after dissociation;}}
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{It was found that}} $n_{\mathrm{id}}$ increas\textcolor[rgb]{0.00,0.07,1.00}{\emph{ed}} (by about 0.03) and $\tau_g$ decreas\textcolor[rgb]{0.00,0.07,1.00}{\emph{ed}} (\textcolor[rgb]{0.00,0.07,1.00}{\emph{by}} about 10~\%) immediately after illumination --- see Fig.~\ref{fig_Time}(a).
...
The fittings with $E_{\mathtt{D,Fe}}=0.68$~eV are in good agreement with \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} experimental data.
...
A small $\tau_g$ alteration (\textcolor[rgb]{0.00,0.07,1.00}{\emph{by}} about 10~\%), caused by light is the evidence of the supporting role of iron--boron pair in SCR recombination.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{These facts allow us to conclude}} that the defect responsible for AI phenomena in nSC is mainly oxide precipitate.
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{while}} C$_i$O$_i$ and  VO$_i$ --- by $\gamma$--rays.\cite{gamma:Stahl,Moll:PhD,gamma:Kolk,A:Caracas}
The RD concentration $N_{t,\mathtt{RD}}$ linearly depend on dose,
...
At the same time, I$_p$--center and BD are characterized by small introduction rate.
For example, the expected\cite{n:gamma,BD:Fret} concentration of BD is only $(1\div2)\cdot10^{10}$~cm$^{-3}$ in nSC and g7SC.
The lack of B$_i$O$_i$ in \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} investigated samples deals with low boron concentration \cite{SiIntDef}.
...
VO$_i$ \textcolor[rgb]{0.00,0.07,1.00}{\emph{is a recombination center which is not active}} in $p$--Si.\cite{gamma:Kolkov,IrrCzpSi:Benton,IrrCzpSi:Coffa,IrrCzpSi:Ganagona,IrrCzpSi:Vines}
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{ and }} $\tau_{n,in}^\mathtt{AA}$ is identical for iSC, nSC, g6SC, and g7SC.
...
Thus\textcolor[rgb]{0.00,0.07,1.00}{\emph{, the}} observed change in base lifetime is caused by AI modification of the same defect (most likely oxide precipitates) in
both non--irradiated and $\gamma$--irradiated samples.
This effect is \textcolor[rgb]{0.00,0.07,1.00}{\emph{enhanced}} by \textcolor[rgb]{0.00,0.07,1.00}{\emph{alteration of}} AI divacancy in neutron--irradiated samples.
In other words, C$_i$O$_i$ is non--AA defect, whereas V$_2$ is AA defect.



\textcolor[rgb]{0.00,0.07,1.00}{\emph{With regard to SCR recombination, in our opinion, under US action,}} $\tau_g$ and $n_\mathrm{id}$ in non--irradiated sample
depend on modification of coupled oxide precipitate related defects.
As assumed in Section \ref{SCR},
...
\textcolor[rgb]{0.00,0.07,1.00}{\emph{while}} VO$_i$ is largo manum produced and can take part in CDLR around $n^+$--$p$
interface in g6SC and g7SC.
The metastable state commonly observed at low temperature is remarkable for the
large oxygen--vacancy distance and \textcolor[rgb]{0.00,0.07,1.00}{\emph{deeper}} energy level.\cite{Bistable:UFN}
...
Hence, under assumption made, VO$_i$ is a favorable pair for AI alteration of distance between component \textcolor[rgb]{0.00,0.07,1.00}{\emph{and therefore,}} can be transformed into metastable configuration by USL, w\textcolor[rgb]{0.00,0.07,1.00}{\emph{hich
...
The analysis has shown that these effects are caused by acoustically induced increase in carrier capture coefficient for point or extended defects.}}
It has \textcolor[rgb]{0.00,0.07,1.00}{\emph{also}} been found that ultrasound loading leads to the reversible modification of SCR carrier lifetime and ideality factor.
The changes are opposite in non--irradiated and irradiated structures.
The qualitative model of \textcolor[rgb]{0.00,0.07,1.00}{\emph{the}} observed phenomenon, which is based on the increase \textcolor[rgb]{0.00,0.07,1.00}{\emph{in the}} distance between coupled defects or between \textcolor[rgb]{0.00,0.07,1.00}{\emph{complex defect components due to ultrasound action, has been suggested}}.
\textcolor[rgb]{0.00,0.07,1.00}{\emph{It has been shown that interstitial carbon--interstitial oxygen complexes practically do not take part in acousto--defect interactions whereas divacancy in neutron-- exposed structures and vacancy--interstitial oxygen pairs in $\gamma$--exposed structures can be effectively modified by applying ultrasound.}}
