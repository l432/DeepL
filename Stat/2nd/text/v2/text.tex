...
\begin{figure}
\includegraphics[width=0.45\textwidth]{olikhFigIllumin}%
\caption{\label{fig_Illum}
Permanent changes of iSC SCR lifetime (a, squares), ideality factor (b, circles), base lifetime (c, triangles), and shunt resistance (d, asterics) versus accumulated illumination time.
