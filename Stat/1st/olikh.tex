...
In the USL case, the acoustic waves were exited with help of a piezoelectric transducer and were injected in the samples from the base side.
The longitudinal (L), $8.0$~MHz in the frequency and $0.18$~W/cm$^2$ in the intensity $W_{U\!S}$, and transverse (T, $4.2$~MHz, $W_{U\!S}\leq0.4$~W/cm$^2$) waves were used.
...
\Fref{figDUS}(a) and \Fref{figDUS}(b) presents the USL influence on SCR carrier lifetime and ideality factor respectively.
One can see that USL leads to $\tau_{g}$ decrease and $n$ increase.
The extent of acoustic effect is weakly depend on both ultrasound intensity and wave type in the sample with a low $R_{sh}$ value.
So, 0.025
...
\begin{table}
\caption{\label{tab}Extracted parameters for the Mo/$n$--Si Schottky structures with and without ultrasonic loading.}
\begin{center}
%\begin{ruledtabular}
...
\hline
$\Delta$n ($\pm0.005$) &0.016&0.024&0.028&0.010&0.022&0.043\\
$\varepsilon_{\tau g}$ ($\pm3$\%)&-12&-14&-17&-5&-18&-30\\
$\varepsilon_{\tau r}$ ($\pm10$\%)&-11&-43&-58&-13&-71&-85\\
\hline
\hline
%$\alpha$ (mV/K) &$-0.22\pm0.02$&$-0.30\pm0.02$\\
%$\Phi_{b,F}(0)$ (mV), Fig.~\ref{figFf} &$817\pm4$ & $839\pm5$\\
%$\Phi_{b,F}(0)$ (mV), Fig.~\ref{figRich} &$821\pm4$ & $845\pm5$\\
%$A^*$ (~A$\,$cm$^{-2}$K$^{-2}$) &$116\pm5$ & $111\pm5$\\
%$\rho_1$ &$0.9995$ & $0.998$\\
%$\rho_2$ &$5\cdot10^{-4}$ & $2\cdot10^{-3}$\\
%$\sigma_{\Phi,1}$ (mV)&$18\pm2$ & $48\pm4$\\
%$\sigma_{\Phi,2}$ (mV)&$118\pm5$ & $127\pm5$\\
%$\overline{\Phi}_{b,1}(0)$ (mV)&$775\pm8$ & $809\pm8$\\
%$\overline{\Phi}_{b,2}(0)$ (mV)&$1070\pm50$ & $1170\pm50$\\
%$T_{0,H}$ (K)&$14\pm1$&$18\pm1$\\
%$T_{0,L}$ (K)&$130\pm5$&$143\pm5$\\
%$\gamma$ ($10^{-5}$ m$^{2/3}$V$^{1/3}$)&$2.7\pm0.1$&$2.5\pm0.1$\\
%$C_p$ ($10^{5}$ m$^{-2}$)&$2.2\pm0.4$&$21\pm3$
\end{tabular}
%\end{ruledtabular}
\end{center}
\end{table}
