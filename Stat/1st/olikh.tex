...
In the article the typical results for the samples with low (about~$10^4$~$\Omega$ at room temperature) and high ($>10^{15}$~$\Omega$) $R_{sh}$ value are presented.
...
\begin{figure}
\begin{center}
\includegraphics[width=15cm]{olikhFig9abc}%
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=15cm]{olikhFig10ab}%
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=15cm]{olikhFig11ab}%
\end{center}
\caption{\label{figFF}
