...
The light  wavelength of $\lambda=900$~nm ensured the electron–-hole pair generation in the $p$-region mainly and low light intensity of $W_{ph}=8$~W/m$^2$ was chosen to avoid any LID processes.
