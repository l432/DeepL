...
In order to prevent irreversible changes in the material properties, we used subthreshold intensity (strain $<2\cdot10^{-6}$).
...
($\tau_\mathrm{other}> 100$~ms).
In the case when the values of $t_\mathrm{ill}$ are small,
$\tau_\mathrm{other}$ changes in the range $10^{-6}-10^{-4}$~s and begins to increase as the illumination time increases.
