...
The reviewer is quite right and vacancy--related defects are investigated extensively ---
for example, see \cite{6HSiC:Vsi,4HSiC:Vc,6HSiC:VV2019,4HSiC:Vacan,SiC:defEPR,6HSiC:VPAS,4HSiC:VV,SiC:bookCh6,
...
We tried to identify the configuration that corresponds to the detected defects, according to the location of the level in the forbidden zone.
