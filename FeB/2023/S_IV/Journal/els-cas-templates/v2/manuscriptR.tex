...
\begin{table}[<options>]
\caption{Wilcoxon signed--rank test results (level of significance $\alpha = 0.05$) for comparing fitness functions.
Symbols ``SE'' and ``AE''  indicate more precise results obtained using$F_\mathrm{SE}$
and $F_\mathrm{AE}$, respectively;
the symbol ``='' suggests no significant difference between the application of functions.
}\label{tblFF}
\begin{tabular*}{\tblwidth}{@{}LCCCCCCCCC@{}}
\toprule
\multirow{2}{*}{Algorithm}& \multicolumn{9}{C}{Extracted parameter} \\
...
\begin{figure}[]
	\centering
		...
		\includegraphics[width=0.49\columnwidth]{Fig5c}
		\includegraphics[width=0.4\columnwidth]{Fig5d}
   ...
   for algorithms in the $I_{01}$, $n_1$, $R_\mathrm{p1}$ (a), $I_{02}$,
                   ...
                   The correspondence between the position (color) of the rectangles (triangles) 
...
\begin{figure}[!ht]
	\centering
		\includegraphics[width=.32\columnwidth]{Fig7a}
        \includegraphics[width=.32\columnwidth]{Fig7b}
        \includegraphics[width=.32\columnwidth]{Fig7c}
	  \caption{The ranking of algorithms in various tasks based on the Friedman (a), Friedman Aligned (b), and Quade (c) tests in the single--\emph{IV} case.
               }\label{figRanksSingleIV}
\end{figure}
...
\caption{Adjusted $p$-values for null hypotheses in $I_{01}$ extraction task.
         ...
         %$p<1.0$ are only shown.
         }\label{tblNNpValueI01}
\begin{tabular*}{\tblwidth}{@{}LCCC@{}}
\toprule
%\multirow{2}{*}{Comparison}& \multicolumn{3}{C}{post-hoc procedure} \\
%  &Nemenyi & Holm & Shaffer\\ % Table header row
Comparison& Nemenyi procedure& Holm procedure& Shaffer’s static procedure\\ % Table header row
\midrule
...
\begin{figure*}[]
	\centering
		\includegraphics[width=.25\textwidth]{AfigA}
        \includegraphics[width=.25\textwidth]{AfigB}
        \includegraphics[width=.25\textwidth]{AfigC}
		\includegraphics[width=.25\textwidth]{AfigD}
        \includegraphics[width=.25\textwidth]{AfigE}
        \includegraphics[width=.25\textwidth]{AfigF}
		\includegraphics[width=.25\textwidth]{AfigG}
        \includegraphics[width=.25\textwidth]{AfigH}
        \includegraphics[width=.25\textwidth]{AfigI}
		\includegraphics[width=.25\textwidth]{AfigJ}
        \includegraphics[width=.25\textwidth]{AfigK}
        \includegraphics[width=.25\textwidth]{AfigL}
		\includegraphics[width=.25\textwidth]{AfigM}
        \includegraphics[width=.25\textwidth]{AfigN}
        \includegraphics[width=.25\textwidth]{AfigO}
