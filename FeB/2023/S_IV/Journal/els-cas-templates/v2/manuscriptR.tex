...
The method is based on DE and incorporates an adaptive local search algorithm using Lagrange interpolation \cite{ADELI}.
This incorporation aims to enhance the exploitation capability and speed up the convergence.
In ADELI, the scaling factor and crossover rate are self-adapting to optimize the results.
