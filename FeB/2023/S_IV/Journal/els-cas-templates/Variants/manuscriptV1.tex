...
but the fourth quadrant of their current-voltage  characteristics (IVCs)
often exhibits an S-shaped kink.
...
The most frequently used conventional SC lumped-parameter models are single-diode model (SDM), double-diode
...
The next step after the model development is the identification of corresponding parameters from the IVCs.
...
No Free Lunch theory (NFL) \cite{NFL} provides the foundation for meta--heuristic algorithm diversity,
stating that no single algorithm can solve all optimization tasks effectively.
...
Regarding the estimation of parameters from S-shaped IV curves, the situation is not as well-explored.
...
However, the NFL theory suggests that algorithms that have demonstrated exceptional results for silicon monocrystalline SC models
