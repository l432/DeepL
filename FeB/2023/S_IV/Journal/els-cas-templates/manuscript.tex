...
\begin{table*}[<options>]
\caption{Adjusted $p$-values for tests for multiple comparisons of $I_{01}$ evaluation
...
%\begin{figure*}[]
%	\centering
%		\includegraphics[width=.32\textwidth]{I01N1}
%        \includegraphics[width=.32\textwidth]{n1N1}
%        \includegraphics[width=.32\textwidth]{Rp1N1}
%		\includegraphics[width=.32\textwidth]{I02N1}
%        \includegraphics[width=.32\textwidth]{n2N1}
%        \includegraphics[width=.32\textwidth]{Rp2N1}
%		\includegraphics[width=.32\textwidth]{RsN1}
%        \includegraphics[width=.32\textwidth]{IphN1}
%        \includegraphics[width=.32\textwidth]{RMSPEN1}
%        \includegraphics[width=.32\textwidth]{ComplN1}
%        \includegraphics[width=.32\textwidth]{Title1N}
%	  \caption{Box--plot of  two--diode model parameter evaluation from single IV curve using different optimizers.
%      Squares are the mean values, and dashed lines correspond to the true parameter values.}\label{figN1RezSingleIV}
%\end{figure*}
...
\begin{figure*}[]
	\centering
	  ...
	  \caption{Dependences of the $I_{01}$ (a, b), $n_1$ (c), $R_\mathrm{p1}$ (d), $I_{02}$ (e, f),
               ...
               The IV-set is used.
               Circles represent the values, which have been used in IV curve simulations,
               squares represent the median values, and stars represent the mean values.
...
%\begin{table}[<options>]
%\caption{Adjusted p-values for multiple comparisons $1\times N$ tests in IV--set case (STLBO is the control algorithm).}\label{tbl1NSTLBO}
%\begin{tabular*}{\tblwidth}{@{}LCCCCCCCCC@{}}
%\toprule
%\multirow{2}{*}{Algorithm}& \multicolumn{9}{C}{Parameter} \\
%  & $I_{01}$& $n_1$ & $R_\mathrm{p1}$ &$I_{02}$& $n_2$& $R_\mathrm{p2}$&$R_\mathrm{s}$&$I_\mathrm{ph}$&RMSPE\\ % Table header row
...
\multirow{2}{*}{Hypothesis}& \multicolumn{3}{C}{post-hoc procedure} \\
  &Nemenyi & Holm & Shaffer\\ % Table header row
\midrule
%EBLSHADE versus WW,&<1E-13&<1E-13&<1E-13\\
%ADELI versus MABC&<1E-13&<1E-13&<1E-13\\
%ADELI versus PSO&<1E-13&<1E-13&<1E-13\\
%ADELI versus ISCA&<1E-13&<1E-13&<1E-13\\
%ADELI versus NNA&<1E-13&<1E-13&<1E-13\\
%ADELI versus CWOA&<1E-13&<1E-13&<1E-13\\
%ADELI versus WW&<1E-13&<1E-13&<1E-13\\
%NDE versus NNA&<1E-13&<1E-13&<1E-13\\
%TLBO versus GOTLBO&<1E-13&<1E-13&<1E-13\\
%TLBO versus PSO&<1E-13&<1E-13&<1E-13\\
%TLBO versus ISCA&<1E-13&<1E-13&<1E-13\\
%TLBO versus NNA&<1E-13&<1E-13&<1E-13\\
%TLBO versus CWOA&<1E-13&<1E-13&<1E-13\\
%STLBO versus GOTLBO&<1E-13&<1E-13&<1E-13\\
%STLBO versus PSO&<1E-13&<1E-13&<1E-13\\
%STLBO versus NNA&<1E-13&<1E-13&<1E-13\\
