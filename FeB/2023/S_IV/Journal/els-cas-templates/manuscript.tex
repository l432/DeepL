...
\begin{table*}[<options>]
\caption{The total count of wins and losses for each algorithm in $1\times N$ multiple comparison using the
...
\toprule
\multirow{3}{*}{Algorithm}& \multicolumn{11}{C}{Win / Lose count} \\
...
Table~\ref{tbl1NWins} summarizes count of wins and losses for each algorithm in $1\times N$ multiple comparison.
...
In this case, a threshold value of $p_{lim}=0.1$ was used, similar to the $1\times N$ multiple comparisons.
...
\begin{table*}[<options>]
\caption{The total count of wins and losses for each algorithm in $N\times N$ multiple comparison using the
...
\toprule
\multirow{2}{*}{Algorithm}& \multicolumn{2}{C}{Win / Lose count} \\
