...
\item
Friedman, Friedman Aligned Ranks, and Quade tests are widely used for comparing the performance differences 
...
\item
Multiple Comparison Tests with Shaffer’s static, Nemenyi, and Holm procedures 
are employed to make pairwise comparisons between groups and identify the differences.
...
%перекласти на англійську "RMSPE ілюструє наскільки апроксимуюча крива збігається з ВАХ"
