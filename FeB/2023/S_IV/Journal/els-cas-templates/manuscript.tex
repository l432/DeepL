...
The statistical results of algorithm's effectiveness comparison in task of $R_\mathrm{p1}$ evaluation are shown in Fig.~\ref{figN1RezSingleIV}(a).
In figure the outperforming of an algorithm in row over the an algorithm in column is indicated by colored hexagon in corresponding cell.
...
%This is the definition of the p-value, which is the
%probability of obtaining a result at least as extreme as the one that
%was actually observed, assuming that H0 is true.
