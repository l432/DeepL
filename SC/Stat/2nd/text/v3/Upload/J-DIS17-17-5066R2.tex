...
Especially considerable acoustically induced alteration of ideality factor and the space charge region lifetime was observed in the irradiated samples.
...
The experimentally observed phenomena are associated with the increase of distance between coupled defects as well as the extension of carrier capture coefficient of complex point defects and dislocations.
...
(iv)~reversibility of the effect of low intensity AW.
...
as well as the US absorption by dislocations\cite{Davletova2008,OstrovKor92,Olikh:Ultras2016}
...
For example, the force acting on the point defect in the crystal under US loading (USL) is determined by the relaxation of defect volume\cite{MirzadeJAP2011,PeleshchakUJF2016}.
...
The observed AI phenomena are accounted for in terms of defect interaction with AW strain field.\cite{MirzadeJAP2011,PeleshchakUJF2016}
...
The dashed, dotted and dot--dashed lines in (a) represent the calculated base, SCR and shunt components of total iSC current (black solid line).
}%
\end{figure*}
...
$\mu_n$ and $\tau_n$ are the mobility and lifetime of electron (minority carrier) in the diode base.
...
In case of USL, the transverse AWs with the frequency of $4.2$~MHz, which were exited by using piezoelectric transducer,  were applied to the samples at the base side in [111]--direction.
...
As shown in Fig.~\ref{fig_n}, the ideality factor decreases with temperature increase, and the  dependence of $n_{\mathrm{id}}$ on $1/T$  is close to linear.
...
\noindent
(i)~irradiation leads to changes in $T_{\mathrm{id}}$ and $E_{\tau g}$ , g6SC's characteristic temperature of ideality factor and SCR lifetime characteristic energy are closely related to those of g7SC under similar conditions;
...
$|u_\mathtt{D}-u_\mathtt{A}|$ (in $\delta=0^\circ$ case) or $|u_\mathtt{D}+u_\mathtt{A}|$ (in $\delta=180^\circ$ case).
...
g6SC defects are coincident to g7SC defects and differs from neutron--irradiated sample defect.
...
The RD concentration $N_{t,\mathtt{RD}}$ linearly depends on dose,
