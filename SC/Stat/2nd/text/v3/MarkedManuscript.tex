...
\begin{abstract}
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The influence of ultrasound on $I$--$V$ characteristics of non-irradiated silicon $n^+$--$p$--structures as well as silicon structures exposed to reactor neutrons or $^{60}$Co gamma radiation have been investigated experimentally.}}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Especially considerable acoustically induced alteration of ideality factor and the space charge region lifetime was observed in the irradiated samples.
...
The \textcolor[rgb]{0.00,0.07,1.00}{\uline{experimentally}} observed phenomena \textcolor[rgb]{0.00,0.07,1.00}{\uline{are associated}} with the increase of distance between coupled defects as well as the extension of carrier capture coefficient of complex point defects and dislocations.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{It has been shown}} that divacancies and \textcolor[rgb]{0.00,0.07,1.00}{\uline{vacancy--interstitial oxygen pairs}} are effectively modified by ultrasound in contrast to interstitial carbon--interstitial oxygen complex\textcolor[rgb]{0.00,0.07,1.00}{\uline{es}}.
\end{abstract}
...
(i)~locality of action due to predominant absorption in \textcolor[rgb]{0.00,0.07,1.00}{\uline{the}} regions of lattice periodicity deviation;
(ii)~selectivity of influence, which depends on acoustic wave (AW) polarization and AW type;
(iii)~possibility \textcolor[rgb]{0.00,0.07,1.00}{\uline{to transform}} the defect system \textcolor[rgb]{0.00,0.07,1.00}{\uline{by applying}} resonance frequency;
(iv)~\textcolor[rgb]{0.00,0.07,1.00}{\uline{reversibility of the effect}} of low intensity AW.
...
However, the ADI is also observed in such non--piezoelectric crystals \textcolor[rgb]{0.00,0.07,1.00}{\uline{as}} silicon, the basic material in microelectronic\textcolor[rgb]{0.00,0.07,1.00}{\uline{s}}.
It was experimentally observed that US \textcolor[rgb]{0.00,0.07,1.00}{\uline{can}} cause
...
Defects are known to determine most of semiconductor devices \textcolor[rgb]{0.00,0.07,1.00}{\uline{characteristics}}.
...
the decreas\textcolor[rgb]{0.00,0.07,1.00}{\uline{e}} in the diffusion activation  energy, \cite{Krevchik}
the local temperature increase caused  by point defect clusters \cite{MirzadeJAP2005}
\textcolor[rgb]{0.00,0.07,1.00}{\uline{as well as}} the US absorption by dislocations\cite{Davletova2008,OstrovKor92,Olikh:Ultras2016}
are \textcolor[rgb]{0.00,0.07,1.00}{\uline{believed}} to be the main mechanisms of elastic vibration--defect interaction in non--piezoelectric crystals.
However, to the best of our knowledge, \textcolor[rgb]{0.00,0.07,1.00}{\uline{there is no a comprehensive ADI theory for silicon suggested so far}}, the lack of experimental \textcolor[rgb]{0.00,0.07,1.00}{\uline{researches}} focused on acoustically induced (AI) effects \textcolor[rgb]{0.00,0.07,1.00}{\uline{being one of the main reasons}}.


The defects in silicon structures are \textcolor[rgb]{0.00,0.07,1.00}{\uline{not all}} acoustically active and \textcolor[rgb]{0.00,0.07,1.00}{\uline{can remain unmodified}} under the action of ultrasound.
The ADI efficiency depends on defect type and structure. \cite{UST:Medvid}
\textcolor[rgb]{0.00,0.07,1.00}{\uline{For example,}} the force acting on the point defect in the crystal \textcolor[rgb]{0.00,0.07,1.00}{\uline{under}} US loading (USL) is determined by the relaxation of defect volume\cite{MirzadeJAP2011,PeleshchakUJF2016}.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The alterations of semiconductor defects are most widely produced by using the well--studied irradiation method.}}
On the one hand, the high--power US treatment of irradiated silicon structures \textcolor[rgb]{0.00,0.07,1.00}{\uline{has been}} shown\cite{YOlikh2007TPL,Parchinskii2006,Gorb2010,Podolian2012} to result \textcolor[rgb]{0.00,0.07,1.00}{\uline{in}} residual changes in structure properties.
...
Unfortunately, there are but \textcolor[rgb]{0.00,0.07,1.00}{\uline{a}} few reports on acoustically driven phenomenon in irradiated silicon structures.

\textcolor[rgb]{0.00,0.07,1.00}{\uline{The aim of our work}} is to investigate experimentally the AI electrical characteristic variation that takes place in non--irradiated and irradiated $n^+$--$p$--Si structures.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{For this purpose, the samples were irradiated}} by reactor neutrons and a $^{60}$Co--gamma source rays.
It is \textcolor[rgb]{0.00,0.07,1.00}{\uline{supposed}} that $\gamma$--rays introduce \textcolor[rgb]{0.00,0.07,1.00}{\uline{predominantly}}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Our work presents}} distinction\textcolor[rgb]{0.00,0.07,1.00}{\uline{s}} between AI effects in silicon structures with different RDs.
The intensity of US applied \textcolor[rgb]{0.00,0.07,1.00}{\uline{was insufficient for}} a new defect formation, RD annealing or long distance (a many interatomic distance) diffusion.
As a result, the \textcolor[rgb]{0.00,0.07,1.00}{\uline{complete}} recovery of characteristics was observed after AW propagation \textcolor[rgb]{0.00,0.07,1.00}{\uline{had stopped}}.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{To describe the processes in space charge region (SCR) and in the diode base as well as to study shunt resistance, we used}} the models of coupled defect level recombination,\cite{CDLR:JAP1995,CDLR:JAP} Shockley--Read--Hall (SRH) recombination and dislocation--induced impedance,\cite{Rsh:Gopal2003,Rsh:Gopal2004} respectively.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The observed AI phenomena are accounted for in terms of}} defect interaction with AW strain field.\cite{MirzadeJAP2011,PeleshchakUJF2016}
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Our research not only provides a}} better understanding of ADI but could also facilitates the development of acoustically controlled devices or radiation sensors.



\section{Experimental and calculation details}
\textcolor[rgb]{0.00,0.07,1.00}{\uline{$n^+$-$p$--Si structure was fabricated from 2~inch (300~$\mu$m thick) p--type boron doped Czochralski silicon wafer with $<$111$>$ orientation and resistivity of 10~$\Omega\cdot$cm.}}
...
The samples \textcolor[rgb]{0.00,0.07,1.00}{\uline{used in the experiment}} were cut from the central part of the wafer and \textcolor[rgb]{0.00,0.07,1.00}{\uline{had the area of $2$~cm$^{2}$}}.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{To determine $D$ and $\Psi$ correlation, the data from Refs.}}~\onlinecite{NIEL:Akkerman,Brauning}\textcolor[rgb]{0.00,0.07,1.00}{\uline{ were used}}.
The non--ionizing energy losses (NIEL) for neutron and $\gamma$--$^{60}$Co are \textcolor[rgb]{0.00,0.07,1.00}{\uline{also}} shown in Table~\ref{tabSample}.
Since the displacement damage effect is characterized by $(\Psi\cdot \mbox{NIEL})$,
a similar damage was expected in \textcolor[rgb]{0.00,0.07,1.00}{\uline{the}} investigated samples \textcolor[rgb]{0.00,0.07,1.00}{\uline{as well}}.
To avoid \textcolor[rgb]{0.00,0.07,1.00}{\uline{the}} impact of  long--term annealing, which is typical \textcolor[rgb]{0.00,0.07,1.00}{\uline{for}} neutron damaged structure, \cite{NIEL:Moll,Rew:Srour} the irradiated samples \textcolor[rgb]{0.00,0.07,1.00}{\uline{were stored  for  five}} years  at  room  temperature before the measurements.
...
Some \textcolor[rgb]{0.00,0.07,1.00}{\uline{of the obtained}} curves are shown in Fig.~\ref{figIV}.
...
The dashed, dotted and dot--dashed lines in (a) represent the calculated base, SCR and shunt components of \textcolor[rgb]{0.00,0.07,1.00}{\uline{total}} iSC current (black solid line).
}%
\end{figure*}
...
\end{eqnarray}
where
$I_{SCR}$ \textcolor[rgb]{0.00,0.07,1.00}{\uline{describes}} the overall SCR recombination,
...
$\mu_n$ and $\tau_n$ are the \textcolor[rgb]{0.00,0.07,1.00}{\uline{mobility and lifetime of electron}} (minority carrier) in the diode base.

We used Eqs. (\ref{eqIV})--(\ref{eqW}) to fit the experimental data \textcolor[rgb]{0.00,0.07,1.00}{\uline{taking}} $\tau_g$, $\tau_n$, $n_{\mathrm{id}}$, $R_{sh}$, and $R_s$ as the  fitting parameters.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Also, we used}} the known \cite{ni:Green,Schroder2006,Markvart} temperature dependences of $n_i$, $E_g$, and $\mu_n$.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{In the result, we obtained}} extremely good fit to the experimental data --- see Fig.~\ref{figIV}.
In particular, for all the samples the \textcolor[rgb]{0.00,0.07,1.00}{\uline{value of}} $R_s$ \textcolor[rgb]{0.00,0.07,1.00}{\uline{was found to be}} about 1~$\Omega$.
The broken lines in Fig.~\ref{figIV}(a) \textcolor[rgb]{0.00,0.07,1.00}{\uline{show}} an example of the calculated contributions of $I_{SCR}$, $I_{base}$, and $I_{sh}$ to the \textcolor[rgb]{0.00,0.07,1.00}{\uline{total}} current.

In case of USL, the transverse AWs with the frequency of $4.2$~MHz, \textcolor[rgb]{0.00,0.07,1.00}{\uline{which}} were exited by using piezoelectric transducer,  were \textcolor[rgb]{0.00,0.07,1.00}{\uline{applied}} to the samples at the base side in [111]--direction.
...
In order to wait \textcolor[rgb]{0.00,0.07,1.00}{\uline{until the AI transitional period is competed}} the following experimental procedure was used.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{When USL started, the sample was first exposed to}} room temperature for 60~min and then the $I$--$V$ measurement and the sample heating were started.
...
The data for nSC and g6SC are similar to \textcolor[rgb]{0.00,0.07,1.00}{\uline{those presented}} for iSC and g7SC.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The parameters of $I$--$V$ characteristics associated with SCR phenomena}} are $n_{\mathrm{id}}$ and $\tau_{g}$.
...
As shown \textcolor[rgb]{0.00,0.07,1.00}{\uline{in}} Fig.~\ref{fig_n}, the ideality factor decreases with temperature increase, and the  \textcolor[rgb]{0.00,0.07,1.00}{\uline{dependence of $n_{\mathrm{id}}$ on $1/T$}}  is close to linear.
...
The temperature dependence of $\tau_{g}$ is \textcolor[rgb]{0.00,0.07,1.00}{\uline{well}} described by the \textcolor[rgb]{0.00,0.07,1.00}{\uline{following}} equation
\begin{equation}
\label{eq_TAUgT}
    \tau_{g}(T)=\tau_{g0}\exp\left(-\frac{E_{\tau g}}{kT}\right)\:.
\end{equation}
The \textcolor[rgb]{0.00,0.07,1.00}{\uline{values of}} $T_{\mathrm{id}}$ and $E_{\tau g}$ \textcolor[rgb]{0.00,0.07,1.00}{\uline{found for}} both non--irradiated and irradiated samples under USL as well as without USL are listed in Table~\ref{tabTpar}.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{We would like}} to stress that

\noindent
(i)~irradiation leads to \textcolor[rgb]{0.00,0.07,1.00}{\uline{changes in}} $T_{\mathrm{id}}$ and $E_{\tau g}$ , g6SC's characteristic temperature of ideality factor and SCR lifetime characteristic energy are closely related to those of g7SC under similar conditions;
...
(where subscripts ``$\mathtt{US}$'' and ``$in$'' \textcolor[rgb]{0.00,0.07,1.00}{\uline{indicate}} the values
...
\noindent
(v)~$\Delta n_{\mathrm{id}}$ and $\varepsilon_{\tau g}$ have opposite sign\textcolor[rgb]{0.00,0.07,1.00}{\uline{s}} for non--irradiated and irradiated samples
...
For the purpose \textcolor[rgb]{0.00,0.07,1.00}{\uline{of our analysis}}, it is important to discuss the recombination mechanism in SCR of the investigated samples.
According to classical SRH theory, the ideality factor must be \textcolor[rgb]{0.00,0.07,1.00}{\uline{smaller}} than 2, and
...
In our case, $n_{\mathrm{id}}$ is \textcolor[rgb]{0.00,0.07,1.00}{\uline{greater}} than 2, and $\tau_g$ increases with temperature.
Therefore, SRH theory \textcolor[rgb]{0.00,0.07,1.00}{\uline{cannot be applied in our case}}.
Several attempts to \textcolor[rgb]{0.00,0.07,1.00}{\uline{account for}} large $n_{\mathrm{id}}$ value have been made \textcolor[rgb]{0.00,0.07,1.00}{\uline{by using different}} models.\cite{Heide,Beier,Shah,Kaminski_n}
\textcolor[rgb]{0.00,0.07,1.00}{\uline{However,}} all \textcolor[rgb]{0.00,0.07,1.00}{\uline{the}} observed features of SCR recombination (\textcolor[rgb]{0.00,0.07,1.00}{\uline{large}} ideality factor, independence on light intensity, dependence on temperature
as well as \textcolor[rgb]{0.00,0.07,1.00}{\uline{short}} carrier lifetime) can be explained by the model of coupled defect level recombination (CDLR) \cite{CDLR:JAP1995,CDLR:JAP} only.
This \textcolor[rgb]{0.00,0.07,1.00}{\uline{mechanism}} provides a rapid  direct  charge  transfer  between  defect levels.
The phenomenon \textcolor[rgb]{0.00,0.07,1.00}{\uline{was first observed}} experimentally,\cite{DAPR:Chen1991,DAPR:Chen1994}  \textcolor[rgb]{0.00,0.07,1.00}{\uline{after which}} it was recruited to explain the process in semiconductor diodes. \cite{CDLR:JAP1995,CDLR:JAP,CDLR:SSP}

According to CDLR model, the recombination is the result of carrier exchange between two defect levels and crystal bands.
In particular, it is \textcolor[rgb]{0.00,0.07,1.00}{\uline{supposed}}\cite{CDLR:JAP} that the recombination rate is dominant \textcolor[rgb]{0.00,0.07,1.00}{\uline{at the}} sites where acceptor--like defect is coupled with donor-like defect.
In a simplified case, \textcolor[rgb]{0.00,0.07,1.00}{\uline{when there is}} no carrier exchange between the donor level $E_t^{\mathtt{D}}$ and valence band,
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Since}} $\tau_g\propto R^{-1}$, the last three values are expected to provide a thermoactivated behavior of SCR lifetime.
...
In our opinion, the observed reversible AI \textcolor[rgb]{0.00,0.07,1.00}{\uline{modifications of}} $n_{\mathrm{id}}$ and $\tau_g$ are induced by
donor--acceptor distance alteration in \textcolor[rgb]{0.00,0.07,1.00}{\uline{the}} samples under USL.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{In fact,}} according to the data,\cite{MirzadeJAP2011,PeleshchakUJF2016} the force acting on a point defect during USL can be expressed as
\begin{equation}
\label{eqFd}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{$\Delta\Omega_d > 0$ for the}} interstitial atoms and substitutional impurities with ionic radius exceeding the ionic radius of matrix
atoms, whereas
for the vacancies and substitutional impurities whose ionic radius is smaller than that of matrix atoms $\Delta\Omega_d < 0$.
Therefore, a point defect vibrates under USL, \textcolor[rgb]{0.00,0.07,1.00}{\uline{so }}oscillation amplitude and phase are determined by both the defect character and \textcolor[rgb]{0.00,0.07,1.00}{\uline{AW intensity}}.
...
Initially\textcolor[rgb]{0.00,0.07,1.00}{\uline{,}} donor and acceptor are separated by the distance $r_{in}$,
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The}} vibration axis coincides with AW displacement direction and forms angle $\varphi$ with  X--axis.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Depending on $\xi_{U\!S}$, defect elastic strain ($\Delta\Omega_d^\mathtt{D}$ and $\Delta\Omega_d^\mathtt{A}$) and defect coupling the defect vibration amplitudes can have different values.}}
The donor--acceptor distance in the sample under USL $r_\mathtt{US}$, \textcolor[rgb]{0.00,0.07,1.00}{\uline{according to the model}}, depends on time $t$:
\begin{multline}
\label{eqrUS}
...
\end{equation*}
In this estimation, the relaxation time in the CDLR sub--system is assumed to be considerably \textcolor[rgb]{0.00,0.07,1.00}{\uline{shorter}} than $T_\mathtt{US}$,
and \textcolor[rgb]{0.00,0.07,1.00}{\uline{we apply the}} previously used\cite{CDLR:JAP} value $a_0=3.23$~nm.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{In addition,}} the chosen $u_\mathtt{D}$ and $u_\mathtt{A}$ values are commensurate with $u_\mathtt{US}$.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{However, it should be}} taken into account, that the displacement of the point defect without covalent bond could exceed a matrix atom displacement.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Finally,}} no US  absorption by defect is assumed.
In this simple case, $\delta$ \textcolor[rgb]{0.00,0.07,1.00}{\uline{is equal}} to $0^\circ$ if $(\Delta\Omega_d^\mathtt{D}\cdot\Delta\Omega_d^\mathtt{A})>0$,
or to $180^\circ$ if $(\Delta\Omega_d^\mathtt{D}\cdot\Delta\Omega_d^\mathtt{A})<0$.
In addition, $\varepsilon_{\mathtt{RDA}}$ \textcolor[rgb]{0.00,0.07,1.00}{\uline{exclusively depends on}}
$|u_\mathtt{D}-u_\mathtt{A}|$ (\textcolor[rgb]{0.00,0.07,1.00}{\uline{in}} $\delta=0^\circ$ case) or $|u_\mathtt{D}+u_\mathtt{A}|$ (\textcolor[rgb]{0.00,0.07,1.00}{\uline{in}} $\delta=180^\circ$ case).
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Relative changes of CCS}} depends on oscillation amplitudes with similar features and
...
Eq.~(\ref{eqEpsSig}) \textcolor[rgb]{0.00,0.07,1.00}{\uline{takes into account}} that $u_\mathtt{D},u_\mathtt{A}\propto \xi_\mathtt{US}\propto\sqrt{W_\mathtt{US}}$.


It is worth keeping in mind that
CDLR current flows locally in the locations of extended defects.\cite{CDLR:JAP,CDLR:SSP}
\textcolor[rgb]{0.00,0.07,1.00}{\uline{At the same time,}} the dislocations are often \textcolor[rgb]{0.00,0.07,1.00}{\uline{located}} perpendicularly to $p-n$ junction plane in the SCR region,
and the investigated samples are not exception (see Section~\ref{Rsh}).
\textcolor[rgb]{0.00,0.07,1.00}{\uline{If coupled defects and dislocations are close to each other,}} then the dislocations with edge component \textcolor[rgb]{0.00,0.07,1.00}{\uline{should}} affect the pair spatial orientation.
...
whereas the axis of a pair of coupled defects with $(\Delta\Omega_d^\mathtt{D}\cdot\Delta\Omega_d^\mathtt{A}<0)$ should make a right angle with \textcolor[rgb]{0.00,0.07,1.00}{\uline{dislocation line}}.
...
Moreover, only squares \textcolor[rgb]{0.00,0.07,1.00}{\uline{should}} to be under consideration in case of $\Delta\Omega_d^\mathtt{D}\cdot\Delta\Omega_d^\mathtt{A}>0$.

Taking into account the experimental results and the estimation \textcolor[rgb]{0.00,0.07,1.00}{\uline{suggested by our model}}:

\noindent
(i)~$E_{\tau g}$ and $T_{\mathrm{id}}$ are mainly determined by couple component energy levels.
The alteration of $E_{\tau g}$ and $T_{\mathrm{id}}$ for nSC, g6SC, and g7SC in comparison with iSC testifies \textcolor[rgb]{0.00,0.07,1.00}{\uline{to}} the change of defect (donor, acceptor, or both)
...
testifies \textcolor[rgb]{0.00,0.07,1.00}{\uline{to}} the rebuilding of  $\gamma$--induced RD,
...
The transformation is confirmed by the \textcolor[rgb]{0.00,0.07,1.00}{\uline{enhanced efficiency of US action}} on defects in irradiated samples.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{In fact}}, in the case of $(\Delta\Omega_d^\mathtt{D}\cdot\Delta\Omega_d^\mathtt{A}<0)$ the US efficiency is determined by the sum of pair component displacements,
whereas in the contrary case  --- by their difference.
In our opinion, both donor and acceptor are \textcolor[rgb]{0.00,0.07,1.00}{\uline{defects}} of interstitial--type in non--irradiated sample, and one of pair components is a \textcolor[rgb]{0.00,0.07,1.00}{\uline{defect}} of vacancy--type in irradiated samples.
...
As expected, minority carrier lifetime increases \textcolor[rgb]{0.00,0.07,1.00}{\uline{as the temperature grows, and at 320~K,
$\tau_n$ values comprise  $2\div5$~$\mu$s for different samples, which
correspond to $80\div130$~$\mu$m range of diffusion lengths.}}
In our opinion, the observed $\tau_n$ dispersion \textcolor[rgb]{0.00,0.07,1.00}{\uline{is caused not}} by irradiation, but \textcolor[rgb]{0.00,0.07,1.00}{\uline{rather}} deals with sample--ancestor wafer inhomogeneity\textcolor[rgb]{0.00,0.07,1.00}{\uline{, which is often the case}}.\cite{Oxide:Chen,Oxide_Schon}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{In fact,}}  the irradiation induced lifetime reduction is described by the Messenger–-Spratt equation:\cite{Markvart}
\begin{equation}
\label{eqMS}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{As seen from the table,}} the estimated value of radiation--induced $\tau_n^{-1}$ change \textcolor[rgb]{0.00,0.07,1.00}{\uline{comprises}} ($8\div17$), 4, and 29~\% of
the values measured for samples nSC, g6SC and g7SC, respectively, \textcolor[rgb]{0.00,0.07,1.00}{\uline{so this}} cannot explain the dispersion observed experimentally.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{At the same time,}} the calculated lifetime changes $K_\tau\Psi$ are in quite good agreement \textcolor[rgb]{0.00,0.07,1.00}{\uline{with the changes}} expected from RDs production --- see Section~\ref{DefectType}.
...
Base lifetime can be expressed as \textcolor[rgb]{0.00,0.07,1.00}{\uline{follows}}:\cite{MurphyJAP2011}
\begin{equation}
\label{eqTAUsum}
\tau_n^{-1}=\tau_\mathtt{bb}^{-1}+\tau_\mathtt{CE\,Auger}^{-1}+\tau_\mathtt{SRH}^{-1}\,,
\end{equation}
where
$\tau_\mathtt{bb}$, $\tau_\mathtt{CE\,Auger}$, $\tau_\mathtt{SRH}$ are the lifetimes of band--to--band \textcolor[rgb]{0.00,0.07,1.00}{\uline{recombination}}, Coloumb--enhanced Auger \textcolor[rgb]{0.00,0.07,1.00}{\uline{recombination}}, and
SRH recombination, respectively.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The}} calculation shows that $\tau_\mathtt{bb}^{-1}=14$~s$^{-1}$, $\tau_\mathtt{CE\,Auger}^{-1}=6$~s$^{-1}$.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Therefore, band--to--band recombination and Auger recombination can be neglected.}}
...
is valid for a complex point defect \textcolor[rgb]{0.00,0.07,1.00}{\uline{as well}}.
In this case\textcolor[rgb]{0.00,0.07,1.00}{\uline{, however,}} $r$ is the distance which separates the components of a complex.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{However}}, not every defect effectively takes part in AID.
...
and depends on \textcolor[rgb]{0.00,0.07,1.00}{\uline{the}} concentration of both AA and non--AA centers
\begin{equation}
\label{eqKeff}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{As seen from the figure,}} the irradiation results in $R_{sh}$ decrease.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Also,}} the $R_{sh}$ temperature dependence \textcolor[rgb]{0.00,0.07,1.00}{\uline{changes}} after $\gamma$--irradiation.
In particular  the shunt resistance decreases with the temperature growth in iSC and nSC,
whereas \textcolor[rgb]{0.00,0.07,1.00}{\uline{in g6SC and g7SC the increase of $R_{sh}$ vs $T$  is close to linear at the vicinity of 293~K.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The shunt resistance is known\cite{Rsh:Breitenstein} to occur in $p$--$n$ structure due to several non--mechanical reasons.
...
Inversion layers and Si$_3$N$_4$ inclusions occur \textcolor[rgb]{0.00,0.07,1.00}{\uline{mainly}} in multicrystalline silicon cells \cite{Rsh:Breitenstein} and cannot cause shunt resistance \textcolor[rgb]{0.00,0.07,1.00}{\uline{in the}} investigated samples.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{According to the model of dislocation--induced impedance of photovoltaic detector suggested}} by Gopal and Gupta,\cite{Rsh:Gopal2003,Rsh:Gopal2004}
...
Eq.~(\ref{eqRsh}) \textcolor[rgb]{0.00,0.07,1.00}{\uline{is true}} for simplified case of $K_p=K_n$.

The resistance temperature coefficient was estimated from \textcolor[rgb]{0.00,0.07,1.00}{\uline{data on g7SC}}.
The obtained value $8.3\cdot10^{-3}$~K$^{-1}$ is not far from resistance temperature coefficient of bulk Al ($4.3\cdot10^{-3}$~K$^{-1}$).
\textcolor[rgb]{0.00,0.07,1.00}{\uline{To fit the experimental data for $R_{sh}$, we used Eqs.~(\ref{eqRshFull})--(\ref{eqRsh}).
...
which was \textcolor[rgb]{0.00,0.07,1.00}{\uline{earlier}} reported\cite{disl10:Castaldini,disl10:Isakova,disl10:Yu,disl10:Kveder,disl10:Trushin}
in Cz--Si:B \textcolor[rgb]{0.00,0.07,1.00}{\uline{as well}}.\cite{disl10:Castaldini,disl10:Isakova,disl10:Yu}


The obtained values of $R_{293,\mathtt{Al}}$ and $\sigma_{\mathtt{dis}}$ are \textcolor[rgb]{0.00,0.07,1.00}{\uline{given}} in Table~\ref{tabTpar}.
$R_{293,\mathtt{Al}}$ does not depend on USL and increases \textcolor[rgb]{0.00,0.07,1.00}{\uline{as}} the irradiation level.
In our opinion, $R_{sh,\mathtt{dis}}$ is \textcolor[rgb]{0.00,0.07,1.00}{\uline{smaller}} than $R_{sh,\mathtt{Al}}$ in iSC.
The irradiation \textcolor[rgb]{0.00,0.07,1.00}{\uline{facilitates the formation }}of vacancies as well as Al diffusion out of the electrodes.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{As a consequence, the number of Al particles grow, $R_{sh,\mathtt{Al}}$ decreases and becomes the key factor contributing in the overall shunt resistance.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Dispersion of $\sigma_{\mathtt{dis}}$ correlate with dispersion of$\tau_n$ over the samples set.}}
...
Therefore\textcolor[rgb]{0.00,0.07,1.00}{\uline{,}} the effective surface area increases and $R_{sh,\mathtt{dis}}$ decreases due to US action.
...
To determine the major recombination center in the investigated samples the following experimental procedure \textcolor[rgb]{0.00,0.07,1.00}{\uline{was}} used.
The non-irradiated sample was light soaked under \textcolor[rgb]{0.00,0.07,1.00}{\uline{illumination by halogen lamp}} (2 Suns) at approximately 305~K.
The illumination \textcolor[rgb]{0.00,0.07,1.00}{\uline{time}} varied from 1~h to 8~h.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{After illumination was terminated, the sample was exposed to room temperature in the darkness.
...
After the total time under illumination \textcolor[rgb]{0.00,0.07,1.00}{\uline{ran}} up to 15~h, the iSC was annealed at 200~$^\circ$C for $10$~min in \textcolor[rgb]{0.00,0.07,1.00}{\uline{darkness}},  \textcolor[rgb]{0.00,0.07,1.00}{\uline{after which }}the measurements were carried out at room temperature.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Then}} the illumination and measurements were repeated.
...
Intensive light is known\cite{LIDRev,LIDRev2} to \textcolor[rgb]{0.00,0.07,1.00}{\uline{cause}} permanent transformation of BO defects and considerable decrease of minority--carrier lifetime (\textcolor[rgb]{0.00,0.07,1.00}{\uline{as low as}} 10~\% of initial value at long term illumination).
Annealing at 200~$^\circ$C for $10$~min in the \textcolor[rgb]{0.00,0.07,1.00}{\uline{darkness results in both recovery of state and readiness to light--induced degradation of}} BO defects.
Fig.~\ref{fig_Illum} shows the changes of structure parameters in comparison with those \textcolor[rgb]{0.00,0.07,1.00}{\uline{prior}} to illumination.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{As seen from the figure,}} illumination does not result in considerable permanent change of $\tau_g$, $\tau_n$, $n_{\mathrm{id}}$ before as well as after annealing.
Therefore, BO influence on recombination can be neglected  in both SCR and the base.

\textcolor[rgb]{0.00,0.07,1.00}{\uline{At the same time,}} the vast majority of impurity iron exists in iron--boron pairs.
Fe$_i$B$_s$ can be readily dissociated under intense illumination \textcolor[rgb]{0.00,0.07,1.00}{\uline{to release interstitial iron,
which results in lifetime changes.}}
In the \textcolor[rgb]{0.00,0.07,1.00}{\uline{darkness, Fe$_i$B$_s$ is repaired}} and Fe$_i$ concentration decreases according to \cite{MurphyJAP2011,Wijaranakula}
\begin{equation}
\label{eqFeB}
N_{Fe}(t)=(N_{Fe,\,0}-N_{Fe,\,eq})\exp\left[-\frac{t}{\tau_{\mathtt{rep}}}\right]+N_{Fe,\,eq}\,,
\end{equation}
where
$N_{Fe,\,0}$ \textcolor[rgb]{0.00,0.07,1.00}{\uline{is the concentration immediately after illumination, and $N_{Fe,\,eq}$ is the equilibrium concentration which remains for a long time after dissociation}};
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{It was found that $n_{\mathrm{id}}$ increased (by about 0.03) and $\tau_g$ decreased (by about 10~\%) immediately after illumination}} --- see Fig.~\ref{fig_Time}(a).
These changes vanished gradually.
We supposed that $\tau_g$ and $n_{\mathrm{id}}$ evolutions could be described by expressions \textcolor[rgb]{0.00,0.07,1.00}{\uline{similar}} to Eq.~(\ref{eqFeB}).
The obtained Eq.~(\ref{eqTrep}) was used to calculate characteristic time, and the fitting lines \textcolor[rgb]{0.00,0.07,1.00}{\uline{are presented}} on Fig.~\ref{fig_Time}(a).
The fittings with $E_{\mathtt{D,Fe}}=0.68$~eV are in good agreement with the experimental data.
Hence, \textcolor[rgb]{0.00,0.07,1.00}{\uline{it is evident that}} iron--boron pairs take part in SCR recombination.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{At the same time,}} electron and hole CCS of Fe$_i$ are 1.7 and 0.04 times \cite{MurphyJAP2011} as much as those of Fe$_i$B$_s$.
A small $\tau_g$ alteration (\textcolor[rgb]{0.00,0.07,1.00}{\uline{by}} about 10~\%), caused by light is \textcolor[rgb]{0.00,0.07,1.00}{\uline{the}} evidence of the supporting role of iron--boron pair in SCR recombination.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{Thus, a conclusion can be made}} that oxide precipitates are number one \textcolor[rgb]{0.00,0.07,1.00}{\uline{agents}} in SCR and base recombinations.
According to Murphy \emph{et al}.\cite{MurphySC2014,MurphyJAP2012},
\textcolor[rgb]{0.00,0.07,1.00}{\uline{there exist}} at least two independent oxide precipitate related defects.
These defects have $\sigma_n/\sigma_p=157$ and $\sigma_p/\sigma_n=1200$ respectively,\cite{MurphyJAP2012} \textcolor[rgb]{0.00,0.07,1.00}{\uline{which}} is suitable for CDLR.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{These facts allow us to conclude}} that the defect responsible for AI phenomena in iSC is mainly oxide precipitate.

\textcolor[rgb]{0.00,0.07,1.00}{\uline{In foreseeing RD type, }}it is worth keeping in mind doping level, oxygen concentration and irradiation dose.
...
The RD concentration $N_{t,\mathtt{RD}}$ \textcolor[rgb]{0.00,0.07,1.00}{\uline{linearly depends on }}dose,
the known introduction rate for neutron $\eta_n$ and gamma $\eta_\gamma$ irradiation in Cz--Si are shown in Table~\ref{tabDefect}.
The expected values of $N_{t,\mathtt{RD}}$ for the investigated samples are listed in Table~\ref{tabDefect} \textcolor[rgb]{0.00,0.07,1.00}{\uline{as well}}.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The other}} defects that can be created by irradiation in silicon are I$_p$--center, bistable donor (BD), B$_i$O$_i$ and C$_i$C$_s$.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{At the same time,}} I$_p$--center and BD are characterized by small introduction rate.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The formation}} of  C$_i$C$_s$ is suppressed in oxygen--rich crystal\cite{gamma:Kolk,gamma:Stahl,n:long} and, \textcolor[rgb]{0.00,0.07,1.00}{\uline{what is more,}}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The}} estimated $\tau_{n,\mathtt{RD}}$ for C$_i$O$_i$, V$_2$, and  V$_3$ are shown in Table~\ref{tabDefect}.
\textcolor[rgb]{0.00,0.07,1.00}{\uline{As seen from the table,}}  $\tau_n$ is effected mainly by C$_i$O$_i$ in $\gamma$--irradiated samples and by vacancy clusters in nSC.
It should be noted, that nSC, g6SC, g7SC sums of $\tau_{n,\mathtt{RD}}^{-1}$ are in quite good agreement with $(K_\tau\cdot\Psi)$ values.

\textcolor[rgb]{0.00,0.07,1.00}{\uline{We shall now consider $K_\mathtt{US}^\mathtt{eff}$ for non--irradiated sample assuming $M_d^\mathtt{AA}=1$ and $M_d^\mathtt{nonAA}=1$.
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{For the analysis the following two limit cases are appropriate.}}
In the first one, non--AA defects are distributed uniformly across the wafer\textcolor[rgb]{0.00,0.07,1.00}{\uline{,}} and
...
These equations are \textcolor[rgb]{0.00,0.07,1.00}{\uline{valid for}}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{In our opinion, under US action, $\tau_g$ and $n_\mathrm{id}$ in non--irradiated sample
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{A few similar}} defects with $\Delta\Omega_d<0$ are known in Si,
viz VO$_2$,\cite{V2Obistable}
V$_3$,\cite{V3:Markevich}
and VO$_i$.\cite{Bistable:UFN}
VO$_2$ \textcolor[rgb]{0.00,0.07,1.00}{\uline{is formed}} after $300^\circ$C annealing of irradiated crystal,
...
The metastable state \textcolor[rgb]{0.00,0.07,1.00}{\uline{commonly observed}} at low temperature is remarkable for the
...
Hence, under assumption made, VO$_i$ is a favorable pair for AI alteration of distance between component and \textcolor[rgb]{0.00,0.07,1.00}{\uline{therefore}}, can be transformed into metastable configuration by USL, \textcolor[rgb]{0.00,0.07,1.00}{\uline{which
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The analysis has shown that these effects are caused by acoustically induced increase in carrier capture coefficient for point or extended defects.}}
...
\textcolor[rgb]{0.00,0.07,1.00}{\uline{The changes are opposite in non--irradiated and irradiated structures.}}
The qualitative model of the observed phenomenon, which is based on the increase in the distance between coupled defects or between complex defect components \textcolor[rgb]{0.00,0.07,1.00}{\uline{due to}} ultrasound action, \textcolor[rgb]{0.00,0.07,1.00}{\uline{has been suggested.
