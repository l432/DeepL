...
The $N_\mathrm{Fe}$--altered test dataset simulates a practical scenario in which
the goal is to predict iron concentration based on PVP variations measured under standardized conditions for predefined structures,
