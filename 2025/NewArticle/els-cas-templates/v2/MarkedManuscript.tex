...
detecting radiation-induced defects via Raman spectroscopy \cite{Park2022,Chia2024},
...
\cite{Macdonald2004,Zoth1990, Rein2, Schmidt2005, Goodarzi2017, Olikh2021JAP, FeMethod2012, Herguth2022}.
\textcolor[rgb]{1.00,0.07,0.00}{
\hl{
...
Both theoretical and experimental studies \cite{IronSC,FeB:Schmidt,Olikh2025MSEB} have demonstrated that the restructuring of iron-related defects (the dissociation of FeB pairs)
leads to
\textcolor[rgb]{1.00,0.07,0.00}{
\hl{
reversible
...
is provided elsewhere \cite{Olikh2025MSEB, Olikh2019SM}.
...
A more detailed description of the sample preparation procedure is available elsewhere [50].}
}
...
(the characteristic recovery time being approximately 600~s at 340~K, compared to 13,000~s at 300~K}
\colorbox{yellow}{ \cite{FeBAssJAP2014,FeBKin2019}).}}
...
Photovoltaic parameters were extracted from the $I$-$V$ curves using a standard procedure} \colorbox{yellow}{\cite{SCparam2017},}
\hl{followed by calculations of their relative changes.
...
\colorbox{yellow}{\cite{FeBAssJAP2014,FeMethod2012, FeBLight2},
temperature \cite{lauer2016},}
\hl{the spectral composition of illumination }\colorbox{yellow}{\cite{OlikhPSSA},}
\hl{and the presence of recombination channels other than those associated with iron-related defects }\colorbox{yellow}{\cite{FeBAssJAP2014,FeBLight2}.}
\hl{The selected illumination duration required to achieve near-complete dissociation depended on the iron concentration
and reached up to 400~s for the solar cells with the highest $N_\mathrm{Fe}$ values.
The illumination intervals were determined based on the results of a previous study }\colorbox{yellow}{\cite{OlikhPSSA},}
...
(described in detail in Subsection}\colorbox{yellow}{~\ref{SecDPP}) ranged from 30 to 8.}
}
...
For example, it has been successfully applied to fault detection and classification based on $I$-$V$ curves }\colorbox{yellow}{\cite{Fadhel2019, Gao2020},}
\hl{performance prediction of organic }\colorbox{yellow}{\cite{David2021} and perovskite \cite{Liu2022} }\hl{solar cells,
as well as measurement of the internal quantum efficiency in GaAs solar cells }\colorbox{yellow}{\cite{AbdullahVetter2025}.}
}
...
In most cases, PCA reduces model performance.
...
&&Init&PCA&Init&PCA&Init&PCA&Init&PCA&Init&PCA&Init&PCA\\
\midrule
RF&4&6.50&13.1&11.6&9.58&18.2&8.92&11.8&12.1&60.4&40.8&45.2&51.3\\
&5&5.59&13.2&5.90&14.2&22.4&6.75&16.6&9.5&62.9&40.7&62.7&42.1\\
&6&4.61&13.3&2.13&5.05&20.8&8.58&35.3&17.7&68.8&43.5&77.3&68.3\\
&7&5.07&9.82&1.94&3.47&21.5&\textbf{12.0}&38.7&21.5&67.4&50.4&79.8&80.6\\
GB&4&5.29&12.5&10.07&9.34&20.7&6.67&5.08&6.58&62.0&42.9&49.8&51.8\\
&5&4.91&12.6&4.89&12.7&19.1&7.00&22.2&4.67&66.2&44.7&65.0&70.7\\
&6&3.41&9.12&\textbf{1.81}&5.14&22.3&11.2&\textbf{40.6}&13.92&73.1&52.4&78.3&70.7\\
&7&5.03&9.93&2.44&3.40&15.6&9.92&31.3&20.8&68.3&50.3&79.3&80.8\\
XGB&4&5.03&10.9&8.72&9.88&22.8&8.92&8.42&7.00&64.6&46.9&53.8&50.3\\
&5&3.65&9.00&5.14&10.5&28.4&8.75&23.7&6.58&67.3&53.0&66.3&48.6\\
&6&\textbf{2.47}&10.4&2.08&5.78&\textbf{33.6}&6.75&34.4&12.3&\textbf{73.7}&49.2&78.0&69.2\\
&7&5.37&9.72&3.38&5.11&14.9&10.2&19.3&13.6&67.9&51.0&78.3&72.9\\
SVR&4&30.9&27.8&36.4&35.7&1.50&1.58&0.67&1.17&15.3&18.3&12.8&13.5\\
&5&33.7&38.0&37.5&47.6&1.75&1.00&0.92&0.67&15.3&12.9&12.8&9.8\\
&6&38.3&40.9&37.1&46.2&1.50&1.50&1.25&0.75&14.3&15.0&12.8&9.58\\
&7&39.3&35.91&36.3&32.2&1.25&1.50&1.83&1.00&10.7&13.3&15.4&14.7\\
...
&7&18.6&\textbf{6.85}&1.88&\textbf{2.53}&3.83&7.5&28.1&\textbf{23.2}&29.8&\textbf{66.3}&\textbf{95.58}&\textbf{92.5}\\
\bottomrule
\end{tabular*}
\end{table}
...
\begin{figure}
  \centering
    ...
    \textcolor[rgb]{1.00,0.07,0.00}{
\hl{
    The vertical lines indicate the temperature values used in the training dataset.}}
}\label{fig10}
\end{figure}
...
As shown earlier }\colorbox{yellow}{\cite{Olikh2025MSEB}, }\hl{the condition of uniqueness in the relationship between $N_\mathrm{Fe}$ and
...
under monochromatic illumination exceed those observed under AM1.5 illumination (see Subsection~}\colorbox{yellow}{\ref{SecDataCol}).}
\hl{The physical origin of the differences in the relationship between iron concentration and
...
photovoltaics-related machine learning tasks }\colorbox{yellow}{\cite{AbdullahVetter2025, Fadhel2019, Gao2020,David2021,Liu2022} ---}
...
So $\varepsilon F\!F$ are shown }\colorbox{yellow}{\cite{Olikh2025MSEB} }\hl{to be most pronounced at low iron concentrations, unlike other PVPs.
...
(see Figs.}\colorbox{yellow}{~\ref{fig7}i-\ref{fig7}l, \ref{fig9}i-\ref{fig9}l).}
\hl{This is because XGB requires less training data than DNN
...
(see Figs.~}\colorbox{yellow}{\ref{fig7}m-\ref{fig7}p, \ref{fig9}m-\ref{fig9}p).}
\hl{As shown by the results in Subsection~}\colorbox{yellow}{\ref{NBaltered}, }\hl{successful prediction within the
$N_\mathrm{B}$--altered also requires accounting for higher-order relationships,
which explains why DNN models achieved the best performance (Figs.~}\colorbox{yellow}{\ref{fig11}e-\ref{fig11}l).}
\hl{Regarding the RF and GB algorithms, as indicated in Tables~}\colorbox{yellow}{\ref{table2} and \ref{table3},}
\hl{they tend to perform best only on less complex data
...
\textcolor[rgb]{1.00,0.07,0.00}{
\hl{
To some extent, the issue of accuracy is related to the applicability of the developed models beyond the selected range of  $N_\mathrm{B}$, $d_p$, and $T$.
...
As previously shown }\colorbox{yellow}{\cite{Olikh2025MSEB}, }\hl{the relationship between the relative changes in the photoelectric parameters
...
obtained using tree-based models for the $T$--altered dataset (see Fig.~}\colorbox{yellow}{\ref{fig9}, Table~\ref{table3}).}
\hl{However, for the training set that included $T$ values beyond the original range,
the performance of these models degraded significantly (see Fig.~}\colorbox{yellow}{\ref{fig10}).}
\hl{Once again, the best average results were achieved by the deep neural network models (see Fig.~}\colorbox{yellow}{\ref{fig9}),}
\hl{and only with their use can relatively accurate predictions beyond the training range of temperature be expected.}
}

\textcolor[rgb]{1.00,0.07,0.00}{
\hl{
The situation is more straightforward concerning the base width,
as its influence on the dependence of $N_\mathrm{Fe}$ on variations in PVPs value is much weaker and often approximately linear }\colorbox{yellow}{\cite{Olikh2025MSEB}.}
\hl{Therefore, in our opinion, the developed models can be expected to remain applicable
