...
In our opinion, for A$^\mathrm{AM1.5}$ models the positive effect of reducing ambiguity between the target variable 
and the input features by increasing the number of descriptors was dominant. 
