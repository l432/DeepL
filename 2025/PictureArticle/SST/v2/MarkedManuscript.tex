...
which, as discussed earlier, constitute the core of the photovoltaic market.
...
\caption
{\color[rgb]{1.00,0.07,0.00}{\colorbox{yellow}{Input parameters used in the simulation of short-circuit current kinetics}} \label{tabParameters}}
\begin{indented}
\item[]
{\color[rgb]{1.00,0.07,0.00}
\colorbox{yellow}{
...
Effective mass  (cm$^2$/Vs)&0.36&0.82&\cite{OMara}\\
\mr
...
eXtreme Gradient Boosting (XGB), Random Forest (RF), Support Vector Regression (SVR), Gradient Boosting (GB), and Deep Neural Network (DNN).
\textcolor[rgb]{1.00,0.07,0.00}{
\hl{
...
Hyperparameter tuning was performed using the five-fold cross-validation and the Optuna toolkit.
...
Tables S6–S10 summarize the optimal hyperparameter combinations that were chosen.
}}
