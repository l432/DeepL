...
\textcolor[rgb]{1.00,0.07,0.00}{
\hl{
Generally Supplementary Figures S1–S10 present a comprehensive set of performance metrics
...
In addition to Supplementary Figures S1–S10, which summarize model performance across all considered training and testing scenarios (see \tref{tabSuplFigs}),
...
The supplementary information related to this article is provided online at \url{https://surl.li/czsgvx}.
...
\begin{tabular}{p{2.0cm} p{3.0cm} p{3.6cm} p{4.2cm} p{4.2cm}}
\hline
Figure(s) &
Training data &
Evaluation setup &
...
Scatter plots of $N_{\mathrm{Fe,PRED}}$ versus $N_{\mathrm{Fe,TRUE}}$ &
Visual assessment of prediction accuracy and systematic deviations \\

S2--S3 &
Simulated &
Training and test (simulated data) &
Heatmaps of MSE, $R^2$, MAPE, and MdAPE &
Baseline comparison and ranking of all 87 model variants \\

S4--S5 &
Simulated ($T = 270$~K) &
Training and test (simulated data) &
Heatmaps of performance metrics at fixed temperature &
Robustness of model performance under temperature-specific conditions \\

S6--S7 &
Simulated &
Test on experimental data (without / with post-hoc calibration) &
Heatmaps of performance metrics &
Impact of post-hoc calibration on experimental predictions \\

S9--S10 &
Experimental &
Training and test (experimental data) &
Heatmaps of performance metrics &
