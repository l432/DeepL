...
We thank the reviewer for this insightful comment. 
Ми погоджуємося, що CNN–regressor models, які навчаються на симульованих даних, learn only the synthetic data distribution.
Проте хочемо підкреслити, що синтетичні дані відображають реальні фізичні закономірності:
вони були отримані на підставі абсолютно прозорих фізичних законів, які описані у розділі 2.2,
під час розрахунків були використані реальні параметри, що згадуються в літературі (див табл.1 з revised manuscript).
Про тісний взаємозв'язок синтетичних та реальних даних свідчать, зокрема достатньо високі величини R2 (0.95-0.98), отримані при застосуванні моделей, 
навчених на симульованих даних до результатів експериментальних вимірювань без корекції та не катастрофічні величини похибок (MedAPE дорівнює 16-23% в кращих випадках) - див. рис. S4.


We respectfully note that we do not fully agree with the interpretation that the CNN–regressor models learn only the synthetic data distribution.
