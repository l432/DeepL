...
Як вже було сказано вище, однією з основних цілей роботи є оцінки можливості використання значень змін фотоелектричних параметрів внаслідок розпаду пар FeB
для оцінки концентрації заліза. 
Одним із найбільш перспективних шляхів в цьому випадку є використання алгоритмів машинного навчання.
При цьому Шіс має виступати в ролі одного з features.
Варто зазначити, що popular preprocessing technique


Варто зазначити, 
The results obtained allow us to assess the feasibility and potential of using the main photovoltaic
parameters of specific solar cells to estimate the 𝑁Fe value across a range of temperatures, including conditions similar
to those encountered in typical SSC applications.



%Standardize features by removing the mean and scaling to unit variance.
%StandardScaler, a provided by scikit-learn, offers a simple yet effective method for standardizing feature values
