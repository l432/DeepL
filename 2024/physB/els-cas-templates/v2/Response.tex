...
and thus, band alignment influences changes in photoelectric conversion parameters resulting from the reconstruction of iron-related defects
...
\textcolor[rgb]{1.00,0.07,0.00}{Furthermore, it has been demonstrated that iron-induced changes in various photovoltaic parameters are correlated.
