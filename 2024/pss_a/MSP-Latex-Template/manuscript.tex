...
The fitting results, shown in Figure~\ref{fig3} as lines and listed in the Table~\ref{tb1},
...
%будь-ласка, покращ англійську мову, виправивши граматичні та силістичні помилки:
...
$3.8\times10^{-15}$~s GE
$2.0\times10^{-15}$~s Osram
$1.5\times10^{-15}$~s Orion



\begin{equation}
\label{eqEaver}
<E>=\frac{\int \frac{hc}{\lambda}n_\mathrm{ph}(\lambda)d\lambda}{\int n_\mathrm{ph}(\lambda)d\lambda}\,.
\end{equation}
