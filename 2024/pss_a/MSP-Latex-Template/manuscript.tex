...
\keywords{silicon, iron-boron pairs, light-induced dissociation, light source impact, dissociation rate}
...
Herein, the results of an experimental study on the kinetic of photo-dissociation of iron–boron (FeB) pairs 
...
The value of the material constant $K$ varies and has been determined to fall within $(1.5-3.8)\times10^{-15}$~s.
...
in the second stage of dissociating the pairs.
...
\textbf{Figure~\ref{fig2}a} shows some typical IV curves.
...
The $N_\mathrm{Fe,0}(t_\mathrm{ill})$ dependencies were fitted using the equation
\begin{equation}
\label{eqNfe0Exp}
...
The effect of the illumination spectra on the on the dissociation of
...
with an increase in photon energy indicates that 
the REDR effect prevails as the dominant factor during the second stage of light-induced dissociation of FeB pairs.
Furthermore, the obtained results could help develop defect engineering procedures 
