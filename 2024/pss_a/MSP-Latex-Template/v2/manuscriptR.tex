...
To measure number of interstitial iron atoms formed over fixed time under strong illumination (box~4) the kinetics of short-circuit current was used (boxes 2 and 3).
...
The obtained results showed that the efficiency of light-induced dissociation increases with decreasing photon wavelength --- see Subsection~\ref{SecLast} and box~7.
...
Meanwhile, the recovery time remains insensitive to the illumination parameters, which is expectable, as the former is determined by $R_a$ (see Equation~(\ref{eqNFet})).
...
The latter arises from strong electron--lattice coupling at the defect site and involves the utilization of local vibrational energy to promote pair dissociation \cite{FeBAssJAP2014,Sun2021,Macdonald2004}.
