...
the current-voltage characteristics ($I$-$V$) of the solar cell was measured every 21 seconds over a time $t_\mathrm{dark}$ of about 3000 seconds.
...
\centering
  ...
  under low-intense LED illumination at 940~nm after delays following the exposure for 50 s to strong ($400$~mW) light (GE lamp) (a) and
...
\centering
  ...
  \caption{Rise of the FeB pair concentration under the illumination by sources Orion (a), Osram (b), GE (c) of different intensities ($T=340$~K).
  Panel (d) compares the effect of different light sources.
  The marks are the experimental results, the lines are the fitting by Eq.~(\ref{eqNfe0Exp}).}
  \label{fig3}
\end{figure}


Considering Eq. (3), the experimentally obtained dependencies $N_\mathrm{Fe,0}(t_\mathrm{ill})$ were fitted using the function
\begin{equation}
\label{eqNfe0Exp}
...
The fitting parameters are collected in \textbf{Table~\ref{tb1}}, which also
includes the coefficients of determination $R^2$.
...
are typically considered: recharge of the iron ion and REDR. The latter arises from strong electron-lattice coupling at the defect site and involves the utilization of local vibrational energy to promote pair dissociation \cite{FeBAssJAP2014,Sun2021,Macdonald2004}.
...
The effect of illumination spectra on dissociation of
...
It was showen that the time required for the total dissociation of FeB pairs
...
$1.5-3.8\times10^{-15}$~s$~s
for the used light sources.
The study of the illumination spectra allowed to conclude that the efficiency of FeB photo-dissociation increases with the photon energy. This, in turn, indicates that
