...
встановити, домінюючий механізм розсіяння, що надзвичайно важливо при розробці нових матеріалів, наноструктур або радіаційно-стійких систем.
...
(но фононах різного типу, іонізованих та нейтральних домішках, дислокаціях, границях зерен, інших носіях, поверхнях тощо).
Зрозуміло, що подібний підхід є складним і далеко не завжди виправданим, що зумовлює застосування різних наближень.
...
Якщо різні процеси розсіяння статистично незалежні, то може бути застосоване правило Матісена 
...
%Літера: \Asbuk{\value{AppendixCount}}
...
\begingroup
\renewcommand{\theequation}{\Asbuk{\value{AppendixCount}}.\arabic{equation}а}
\begin{eqnarray}
  \label{eqK4a}
