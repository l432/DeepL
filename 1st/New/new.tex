...
It have been shown that complexes VO$_i$, С$_i$C$_s$, $H$--centre (V$_2$O$_i$), $\Gamma$--centre, and interstitial defect $I^{0/-}$ are the main radiation defects.
...
E.g. the value $m_\mathrm{F}\approx1,3$, which is observed for the investigated structure after $\gamma$--irradiation and before UST, is evident of the exponential trap distribution.
...
The $P_b$--center annealing is known \cite{SiO2:Takakura,SiO2:Wurzer} to deal with 

%Виявлене збільшення $I_0$ свідчить, відповідно до формули~(\ref{eqIoSCLC}), про АІ зменшення концентрації $P_b$--центрів,
...
%а зростання $m_\mathrm{F}$ (або, що те саме, $T_c$) --- про звуження енергетичного розподілу відповідних рівнів.
