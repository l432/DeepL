...
\title{Acoustical and irradiate driving of current mechanism in AuЦ-SiO$_2$Ц-Si structure}
...
\begin{keyword}
metal--semiconductor structures\sep SiЦ-SiO$_2$ interface\sep ultrasound influence\sep $\gamma-$rays
\end{keyword}
...
after UST have been determined by capacitanceЦvoltage characteristics measurements \cite{Parchinskii2000,Parchinskii2006}.
...
The characteristics of the AuЦ-SiO$_2$Ц-Si structure, after $\gamma$--irradiation and after UST, were investigated using an  current--voltage ($I-V$) technique. 
...
Fig.~\ref{figIV} shows $IЦV$ characteristics for both initial and irradiated Au--SiO$_2$--Si structure as well as after the sequent USTs.
One can see that $IЦV$ characteristic for non-irradiated sample is typical for Schottky diode:
...
%ƒл€ апроксимац≥њ пр€моњ г≥лки ¬ј’ був використаний вираз (\ref{eqSDIV});
%результат апроксимац≥њ показано на рис.~\ref{figIV_MIS},а та б, визначен≥ параметри
%наведен≥ в табл.~~\ref{tabMIS}.
